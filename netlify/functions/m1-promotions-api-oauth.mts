...
import { API_TEST_ORIGIN, API_OAUTH_PATH, API_CALLBACK_PATH, PROMOTIONS_API_ENV_KEYS, promotionsApiConfig } from './_lib/promotions-api.mts';
import { handleApiOAuth, oauthJson, authorizedApiSetupRequest } from './_lib/promotions-api-oauth.mts';

export const config = { path:[API_OAUTH_PATH,API_CALLBACK_PATH], rateLimit:{windowLimit:20,windowSize:60,aggregateBy:['ip','domain']} };
